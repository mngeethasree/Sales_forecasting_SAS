...
proc esm data=Work.preProcessedData back=12 lead=12 seasonality=12 plot=(corr 
	...
	forecast Sales / alpha=0.05 model=addwinters transform=none;
run;
...
%accuracy_prep(indsn=PRO.MONTHLY_SALES, series=Sales, timeid='Order Date'n, 
    numholdback=&nhold);

%accuracy(indsn=work.out0001, timeid='Order Date'n, series=Sales, 
    numholdback=&nhold);